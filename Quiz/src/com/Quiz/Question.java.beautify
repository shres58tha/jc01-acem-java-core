...
public class Question
{
    ...
    public void questions () {
        String[] questions = {
            "\n\n1: Which of the following declares an array of integers named number?\n\n1) int number ;\n2) int [ ] number ;\n3) int new number [ ] ;\n4) int number = int [ ] ;",
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (answer.toUpperCase(Locale.ROOT).equals(answers[i].toUpperCase(Locale.ROOT))) {
